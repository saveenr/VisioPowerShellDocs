...
#### Zoom to objects in a drawing <a href="#zoom-to-objects-in-a-drawing" id="zoom-to-objects-in-a-drawing"></a>
...
#### Zoom to a specific zoom level <a href="#zoom-to-a-specific-zoom-level" id="zoom-to-a-specific-zoom-level"></a>
...
#### Incrementally changing the zoom <a href="#incrementally-changing-the-zoom" id="incrementally-changing-the-zoom"></a>
