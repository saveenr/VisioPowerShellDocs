...
* [`Get-VisioCustomProperty`](get-visiocustomproperty.md): read the custom properties on one or more shapes.
* [`Set-VisioCustomProperty`](set-visiocustomproperty.md): add or update a custom property by name (or pass a populated `CustomPropertyCells` for fine-grained control).
* [`Remove-VisioCustomProperty`](remove-visiocustomproperty.md): delete a custom property by name.
