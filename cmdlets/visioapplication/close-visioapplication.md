...
> **Note:** open documents are closed without prompting, even if they have unsaved changes. Save first if you need to keep the work &mdash; see [Save-VisioDocument](../documents/save-visiodocument.md).
...
* [Close-VisioDocument](../documents/close-visiodocument.md) &mdash; close individual documents without exiting Visio.
